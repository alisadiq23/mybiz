...
class _PurchasesPageState extends State<Purchases> {
  ...
  Container headerSection() {
    ...
    return Container(
     ...
     rows: [
      DataRow(cells: [
        DataCell(Text('Purchases', style: TextStyle(fontSize: 14))),
      ...
      DataRow(cells: [
        DataCell(Text('Cash Purchases', style: TextStyle(fontSize: 14))),
        DataCell(Text('5984210.00', style: TextStyle(fontSize: 14)), showEditIcon: true), //later to be implement with the database. making it numerical also perhaps
      ]),
      DataRow(cells: [
        DataCell(Text('Purchases Return / Discount', style: TextStyle(fontSize: 14))),
        DataCell(Text('5984210.00', style: TextStyle(fontSize: 14)), showEditIcon: true), //later to be implement with the database. making it numerical also perhaps
      ]),
     ],
   );
