...
class ClosingStock extends StatefulWidget {
  @override
  _ClosingStockPageState createState() => _ClosingStockPageState();
}

class _ClosingStockPageState extends State<ClosingStock> {
  ...
  Container headerSection() {
    ...
    return Container(
     ...
     rows: [
      DataRow(cells: [
        DataCell(Text('Closing Stock', style: TextStyle(fontSize: 14))),
