...
class OpeningStock extends StatefulWidget {
  @override
  _OpeningStockPageState createState() => _OpeningStockPageState();
}

class _OpeningStockPageState extends State<OpeningStock> {
  ...
  Container headerSection() {
    ...
    return Container(
     ...
     rows: [
      DataRow(cells: [
        DataCell(Text('Opening Stock', style: TextStyle(fontSize: 14))),
