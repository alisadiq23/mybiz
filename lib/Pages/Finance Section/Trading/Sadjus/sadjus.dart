...
class Sadjus extends StatefulWidget {
  @override
  _SadjusPageState createState() => _SadjusPageState();
}

class _SadjusPageState extends State<Sadjus> {
  ...
  Container headerSection() {
    ...
    return Container(
     ...
     rows: [
      DataRow(cells: [
        DataCell(Text('Sales Return / Discount', style: TextStyle(fontSize: 14))),
      ...
      DataRow(cells: [
        DataCell(Text('Sales Rounding Adjustment', style: TextStyle(fontSize: 14))),
        DataCell(Text('5984210.00', style: TextStyle(fontSize: 14)), showEditIcon: true), //later to be implement with the database. making it numerical also perhaps
      ]),
      DataRow(cells: [
        DataCell(Text('Voucher Discount', style: TextStyle(fontSize: 14))),
        DataCell(Text('5984210.00', style: TextStyle(fontSize: 14)), showEditIcon: true), //later to be implement with the database. making it numerical also perhaps
      ]),
     ],
   );
