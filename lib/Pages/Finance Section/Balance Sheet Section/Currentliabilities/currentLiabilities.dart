...
class CurrentLiabilities extends StatefulWidget {
  @override
  _CurrentLiabilitiesPageState createState() => _CurrentLiabilitiesPageState();
}

class _CurrentLiabilitiesPageState extends State<CurrentLiabilities> {
  ...
  Container headerSection() {
    return Container(
      ...
      child: Text("CL (CURRENT LIABILITES)",
          style: TextStyle(
              fontSize: 30.0,
    ...
    return Container(
     ...
     rows: [
      DataRow(cells: [
        DataCell(Text('Loan - PBe', style: TextStyle(fontSize: 14))),
      ...
      DataRow(cells: [
        DataCell(Text('Loan - MayBank', style: TextStyle(fontSize: 14))),
        DataCell(Text('5984210.00', style: TextStyle(fontSize: 14)), showEditIcon: true), //later to be implement with the database. making it numerical also perhaps
      ]),
     ],
   );
