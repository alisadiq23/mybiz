...
class SCcapital extends StatefulWidget {
  @override
  _SCcapitalPageState createState() => _SCcapitalPageState();
}

class _SCcapitalPageState extends State<SCcapital> {
  ...
  Container headerSection() {
    ...
    return Container(
     ...
     rows: [
      DataRow(cells: [
        DataCell(Text('Boss', style: TextStyle(fontSize: 14))),
