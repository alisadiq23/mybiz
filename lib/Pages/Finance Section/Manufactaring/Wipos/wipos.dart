...
class Wipos extends StatefulWidget {
  @override
  _WiposPageState createState() => _WiposPageState();
}

class _WiposPageState extends State<Wipos> {
  ...
  Container headerSection() {
    ...
    return Container(
     ...
     rows: [
      DataRow(cells: [
        DataCell(Text('WIP O/S', style: TextStyle(fontSize: 14))),
