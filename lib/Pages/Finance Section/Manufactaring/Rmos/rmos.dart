...
class Rmos extends StatefulWidget {
  @override
  _RmosPageState createState() => _RmosPageState();
}

class _RmosPageState extends State<Rmos> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Manufactaring'),),
      body: Container(
  ...
  Container headerSection() {
    ...
    return Container(
     ...
     rows: [
      DataRow(cells: [
        DataCell(Text('Raw Material O/S', style: TextStyle(fontSize: 14))),
