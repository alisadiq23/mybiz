...
import 'package:mybiz/Pages/Finance Section/finance.dart';
...
@override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Executive", style: TextStyle(color: Colors.white)),
        actions: <Widget>[
        ],
      ),
      body: Center(child: Text("Executive page test/this is a test for the drawer")),
      drawer: Drawer(
        child:SafeArea(
        left: true,
        top: true,
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
              Navigator.pop(context);
              Navigator.push(context, MaterialPageRoute(builder: (context) => FinancePage(), fullscreenDialog: true));
              }
            ),
